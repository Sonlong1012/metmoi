...
namespace Webbanhang_22011267.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["DanhMucID"] = new SelectList(_context.Category, "Id","TenDanhMuc");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DanhMucID,Ten,Gia,SoLuong,NgayNhap,ThuongHieu,MoTa,Hinh")] Product product)
        {
            ...
            ViewData["DanhMucID"] = new SelectList(_context.Category,"Id", "TenDanhMuc", product.DanhMucID);
            return View(product);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,DanhMucID,Ten,Gia,SoLuong,NgayNhap,ThuongHieu,MoTa,Hinh")] Product product)
        {
            ...
            ViewData["DanhMucID"] = new SelectList(_context.Category, "Id", "Id", product.DanhMucID);
            return View(product);
        }
