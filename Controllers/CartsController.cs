    ...
    public class CartsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cart != null ? 
                          ...
                          Problem("Entity set 'AppDBContext.Cart'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NguoiDungId")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NguoiDungId")] Cart cart)
        {
            if (id != cart.Id)
            {
                return NotFound();
